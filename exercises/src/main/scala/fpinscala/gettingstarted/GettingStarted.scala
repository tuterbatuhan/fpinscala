...
object TestIsSorted {
  ...
  def main(args: Array[String]): Unit = {
    println(isSorted(Array(1,2,3),(x:Int, x_prev:Int) => x>x_prev))
    println(isSorted(Array(1,2,4),(x:Int, x_prev:Int) => x>x_prev))
    println(isSorted(Array(2,1,4),(x:Int, x_prev:Int) => x>x_prev))
    println(isSorted(Array(2),(x:Int, x_prev:Int) => x>x_prev))
  }
}
